  ...
  return (
    <div>
      <div className='bg-black text-grey-400 h-[100px] max-w-[1200px] mx-auto flex justify-between items-center'>
        <h1 className='text-3xl font-bold primary-color ml-4'>Rahul Das</h1>
        <ul className='hidden md:flex'>
          <li className='p-5 text-white'><a href="#about">About</a></li>
          <li className='p-5  text-white'><a href="#work">Work</a></li>
      ...
      >
        <h1 className='text-3xl primary-color ml-4'>Rahul Das</h1>
        <ul className='p-8 text-2xl'>
          <li className='p-2  text-white'><a href="#about">About</a></li>
          <li className='p-2  text-white'><a href="#work">Work</a></li>
